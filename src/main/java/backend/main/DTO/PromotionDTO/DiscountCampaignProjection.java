 ...
 * Match với query: SELECT
 * a.id,a.name,a.description,a.campaign_type,a.start_date,a.end_date,a.is_active,a.created_at,a.priority,
 * b.value,b.max_discount,b.min_order_value,dt.target_type,dt.is_included
 * FROM discount_campaigns a JOIN discounts b ON a.id=b.campaign_id JOIN
 * discount_targets dt ON dt.id= b.id
 */
