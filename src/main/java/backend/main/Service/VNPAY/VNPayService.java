package backend.main.Service.VNPAY;
...
public class VNPayService {
    ...
    public String createOrder(HttpServletRequest request, Long amount, String orderInfo, String urlReturn) {
        ...
        // Gán URL trả về sau khi thanh toán (trang thankyou)
    ...
    public String queryTransaction(String orderId, String transDate, HttpServletRequest req) throws IOException {
        ...
        System.out.println("QueryDR Response Code: " + responseCode);
        System.out.println("QueryDR Response: " + response);

        return response.toString();
    }

    // ==== Refund API ====
    public String refundTransaction(HttpServletRequest req) throws IOException {
        ...
        String vnp_TransactionNo = ""; // nếu hệ thống bạn không lưu transactionNo thì để trống
    ...
    public String createPaymentUrl(CheckoutRequest formData, String clientIp) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String orderType = "other";

        long amount = formData.getTotalPrice().longValue() * 100;
        String bankCode = "NCB"; // thêm field vào FormDataRequest nếu có
